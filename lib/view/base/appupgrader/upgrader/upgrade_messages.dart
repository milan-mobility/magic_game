...
class UpgraderMessages {
  ...
  UpgraderMessages({final String? code})
  ...
  String? message(final UpgraderMessage messageKey) {
    switch (messageKey) {
  ...
  static String findLanguageCode({final BuildContext? context}) {
    Locale? locale;
    if (context != null) {
  ...
  String get body {
    ...
    switch (languageCode) {
      ...
      default:
        ...
        message =
            'New app version available, please update to use the latest features.'
                .tr;
        break;
    }
    return message;
  ...
  String get title {
    ...
    switch (languageCode) {
      ...
      case 'en':
      default:
        message = 'New Update Available'.tr;
        break;
    }
    return message;
  }
