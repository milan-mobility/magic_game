...
import 'package:magic_games/view/base/appupgrader/upgrader/alert_style_widget.dart';
...
class UpgradeCard extends UpgradeBase {
  ...
  Widget build(final BuildContext context, final UpgradeBaseState state) {
    if (upgrader.debugLogging) {
      debugPrint('upgrader: build UpgradeCard');
    }
          ...
          (
            ...
            if ((snapshot.connectionState == ConnectionState.waiting ||
              ...
              if (upgrader.shouldDisplayUpgrade()) {
                ...
                if (upgrader.debugLogging) {
                  debugPrint('upgrader: UpgradeCard will not display');
                }
              }
            }
  ...
  Widget buildUpgradeCard(
    ...
    if (upgrader.debugLogging) {
      debugPrint('upgrader: UpgradeCard: will display');
      debugPrint('upgrader: UpgradeCard: showDialog title: $title');
      debugPrint('upgrader: UpgradeCard: showDialog message: $message');
      debugPrint(
        'upgrader: UpgradeCard: shouldDisplayReleaseNotes: $shouldDisplayReleaseNotes',
      );

      debugPrint(
        'upgrader: UpgradeCard: showDialog releaseNotes: $releaseNotes',
      );
    }
      ...
      notes = Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Text(releaseNotes, maxLines: 15, overflow: TextOverflow.ellipsis),
          ],
        ),
      );
    }
