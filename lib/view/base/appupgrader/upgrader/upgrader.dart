...
import 'package:magic_games/view/base/appupgrader/upgrader/appcast.dart';
import 'package:magic_games/view/base/appupgrader/upgrader/itunes_search_api.dart';
import 'package:magic_games/view/base/appupgrader/upgrader/play_store_search_api.dart';
...
typedef WillDisplayUpgradeCallback =
    void Function({
...
class Upgrader with WidgetsBindingObserver {
  Upgrader({
    ...
    if (debugLogging) debugPrint('upgrader: instantiated.');
  }
  ...
  void installPackageInfo({final PackageInfo? packageInfo}) {
    _packageInfo = packageInfo;
    _initCalled = false;
  }

  void installAppStoreVersion(final String version) {
    _appStoreVersion = version;
  }

  void installAppStoreListingURL(final String url) {
  ...
  Future<bool> initialize() async {
    if (debugLogging) {
      debugPrint('upgrader: initialize called');
    }
    if (_futureInit != null) return _futureInit!;

    _futureInit = Future(() async {
      if (debugLogging) {
        debugPrint('upgrader: initializing');
      }
      if (_initCalled) {
      ...
      if (messages.languageCode.isEmpty) {
        debugPrint('upgrader: error -> languageCode is empty');
      } else if (debugLogging) {
        debugPrint('upgrader: languageCode: ${messages.languageCode}');
      }
      ...
      if (debugLogging) {
        debugPrint(
          'upgrader: default operatingSystem: '
          '${upgraderOS.operatingSystem} ${upgraderOS.operatingSystemVersion}',
        );
        debugPrint('upgrader: operatingSystem: ${upgraderOS.operatingSystem}');
        debugPrint(
          'upgrader: '
      ...
      if (_packageInfo == null) {
        ...
        if (debugLogging) {
          ...
          debugPrint(
            'upgrader: package info appName: ${_packageInfo!.appName}',
          );
          debugPrint(
            'upgrader: package info version: ${_packageInfo!.version}',
          );
        }
      }
  ...
  Future<bool> _updateVersionInfo() async {
    ...
    if (_isAppcastThisPlatform()) {
      if (debugLogging) {
        debugPrint('upgrader: appcast is available for this platform');
      }
      ...
      if (debugLogging) {
        ...
        debugPrint('upgrader: appcast item count: $count');
      }
      ...
      if (bestItem != null &&
        ...
        try {
          ...
          debugPrint(
            'upgrader: updateVersionInfo could not parse version info $e',
          );
      ...
      if (upgraderOS.isAndroid) {
        ...
        if (response != null) {
          ...
          if (mav != null) {
            ...
            if (debugLogging) {
              debugPrint(
                'upgrader: ITunesResults.minAppVersion: $minAppVersion',
              );
            }
          }
        }
  ...
  Future<bool?> _getAndroidStoreVersion({
    ...
    final response = await (playStore.lookupById(
      id,
      country: country,
      language: language,
    ));
    if (response != null) {
      ...
      if (debugLogging && _appStoreVersion == null) {
        debugPrint(
          'upgrader: Play Store version could not be found in response',
        );
      }
      _appStoreListingURL ??= playStore.lookupURLById(
        id,
        language: language,
        country: country,
      );
      ...
      if (mav != null) {
        ...
        if (debugLogging) {
          debugPrint(
            'upgrader: PlayStoreResults.minAppVersion: $minAppVersion',
          );
        }
      }
    }
  ...
  bool _isAppcastThisPlatform() {
    ...
    if (appcastConfig!.supportedOS != null) {
      supported = appcastConfig!.supportedOS!.contains(
        upgraderOS.operatingSystem,
      );
    }
    return supported;
  }
  ...
  void checkVersion({required final BuildContext context}) {
    if (!_displayed) {
  ...
  bool shouldDisplayUpgrade() {
    ...
    if (debugLogging) {
      debugPrint('upgrader: blocked: $isBlocked');
      debugPrint('upgrader: debugDisplayAlways: $debugDisplayAlways');
      debugPrint('upgrader: debugDisplayOnce: $debugDisplayOnce');
      debugPrint('upgrader: hasAlerted: $_hasAlerted');
    }
    ...
    if (debugLogging) {
      debugPrint('upgrader: shouldDisplayUpgrade: $rv');
    }
  ...
  bool isTooSoon() {
    ...
    if (rv && debugLogging) {
      debugPrint('upgrader: isTooSoon: true');
    }
    return rv;
  }
  ...
  bool alreadyIgnoredThisVersion() {
    ...
    if (rv && debugLogging) {
      debugPrint('upgrader: alreadyIgnoredThisVersion: true');
    }
    return rv;
  }
  ...
  bool isUpdateAvailable() {
    if (debugLogging) {
      debugPrint('upgrader: appStoreVersion: $_appStoreVersion');
      debugPrint('upgrader: installedVersion: $_installedVersion');
      debugPrint('upgrader: minAppVersion: $minAppVersion');
    }
    if (_appStoreVersion == null || _installedVersion == null) {
      if (debugLogging) debugPrint('upgrader: isUpdateAvailable: false');
      return false;
    }
    ...
    try {
      ...
      if (debugLogging) {
        debugPrint('upgrader: isUpdateAvailable: $e');
      }
    }
    final isAvailable = _updateAvailable != null;
    if (debugLogging) debugPrint('upgrader: isUpdateAvailable: $isAvailable');
    return isAvailable;
  }
  ...
  /// is `US`.
  String? findCountryCode({final BuildContext? context}) {
    Locale? locale;
    if (context != null) {
  ...
  /// from the system-reported default locale of the device. The default
  /// is `en`.
  String? findLanguageCode({final BuildContext? context}) {
    Locale? locale;
    if (context != null) {
      locale = Localizations.maybeLocaleOf(context);
    } else {
  ...
  void _showDialog({
    ...
    required final bool canDismissDialog,
  }) {
    if (debugLogging) {
      debugPrint('upgrader: showDialog title: $title');
      debugPrint('upgrader: showDialog message: $message');
      debugPrint('upgrader: showDialog releaseNotes: $releaseNotes');
    }
  ...
  bool _shouldPopScope() {
    if (debugLogging) {
      debugPrint('upgrader: onWillPop called');
    }
    if (shouldPopScope != null) {
      final should = shouldPopScope!();
      if (debugLogging) {
        debugPrint('upgrader: shouldPopScope=$should');
      }
      return should;
    }
  ...
  void onUserIgnored(final BuildContext context, final bool shouldPop) {
    if (debugLogging) {
  ...
  void onUserLater(final BuildContext context, final bool shouldPop) {
    if (debugLogging) {
  ...
  void onUserUpdated(final BuildContext context, final bool shouldPop) {
    if (debugLogging) {
  ...
  void popNavigator(final BuildContext context) {
  ...
  void _sendUserToAppStore() async {
    if (_appStoreListingURL == null || _appStoreListingURL!.isEmpty) {
      if (debugLogging) {
        debugPrint('upgrader: empty _appStoreListingURL');
      }
      return;
    }

    if (debugLogging) {
      debugPrint('upgrader: launching: $_appStoreListingURL');
    }
    ...
    if (await canLaunchUrl(Uri.parse(_appStoreListingURL!))) {
      try {
        ...
        if (debugLogging) {
          debugPrint('upgrader: launch to app store failed: $e');
        }
      }
    } else {}
  }
